...
!(function (r) {
  ...
  function n(r, t, e) {
    ...
    var a = i.measureText(e.label).width,
      ...
      h = 0.01;
    1 === e.mode
      ? r.addBlank(0, l - h, n, s + h)
      : r.addBlank(c - h, l - h, g + h, s + h),
  ...
  function c(r, t, e, n, o, i, a, c) {
    var l = r.isDark,
      ...
      C = l(a, w);
    p
      ? u(t, n, o, g, s, h, !T && !C, !T && !A, !k && !A, !k && !C)
      : f(t, n, o, g, s, h, T && C && y, T && A && B, k && A && E, k && C && M);
  }
  function l(r, t, e) {
    var n,
      o,
      ...
      f = a;
    for (
      p && e.radius > 0 && e.radius <= 0.5 && (f = c), t.beginPath(), n = 0;
      i > n;
      n += 1
    )
      for (o = 0; i > o; o += 1) {
    ...
    var r = (function () {
      ...
      var t = function (t, e) {
        var o = 236,
          ...
          k = function (r, t) {
            for (
              var e = (g << 3) | t, n = i.getBCHTypeInfo(e), o = 0;
              15 > o;
              o += 1
            ) {
              var a = !r && 1 == ((n >> o) & 1);
          ...
          D = function (r, t, e) {
            for (
              var n = u.getRSBlocks(r, t), c = f(), l = 0;
              l < e.length;
              l += 1
            ) {
              var g = e[l];
              c.put(g.getMode(), 4),
                c.put(g.getLength(), i.getLengthInBits(g.getMode(), r)),
                g.write(c);
            }
            ...
            u = function (r) {
              ...
              for (s += 1; s < o.length; ) {
                ...
                (s += 1),
                  i.contains(h + v)
                    ? (h += v)
                    : (g.write(i.indexOf(h), n),
                      i.size() < 4095 &&
                        (i.size() == 1 << n && (n += 1), i.add(h + v)),
                      (h = v));
              }
              return (
                g.write(i.indexOf(h), n),
